...
@Algs = ("p8tm-psi-v2-improved 0 20","p8tm-psi-v2-improved-lc-hidden 0 20"#,"htm-sgl"
...
# Path to executables
$ExePath = "/home/miguel.figueiredo/projs/PersistentSiHTM/POWER8TM/benchmarks/datastructures/";
